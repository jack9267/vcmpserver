...
namespace BasicDataStructures
{
	...
	public:
		...
		queue_type& operator[] ( unsigned int position ); // Not a normal thing you do with a queue but can be used for efficiency
	...
	template <class queue_type>
	inline queue_type& Queue<queue_type>::operator[] ( unsigned int position )
	{
#ifdef _DEBUG
