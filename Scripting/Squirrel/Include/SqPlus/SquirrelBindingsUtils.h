...
#define _DECL_NATIVE_CONSTRUCTION2(classname,cppclass) \
...
#define _IMPL_NATIVE_CONSTRUCTION2(classname,cppclass) \
...
#define _IMPL_NATIVE_CONSTRUCTION_NODELETE(classname,cppclass) \
static int classname##_release_hook(SQUserPointer p, int size) \
{ \
	return 0; \
} \
