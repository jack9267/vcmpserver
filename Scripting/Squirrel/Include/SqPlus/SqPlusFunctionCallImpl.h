...
SQINLINE bool	Match(TypeWrapper<bool>,HSQUIRRELVM v,int idx)           
{ 
	if ( sq_gettype(v,idx) & SQOBJECT_CANBEFALSE ) return true;
	return false;
}
SQINLINE bool	Match(TypeWrapper<signed char>,HSQUIRRELVM v,int idx)    { return sq_gettype(v,idx) == OT_INTEGER; }
SQINLINE bool	Match(TypeWrapper<unsigned char>,HSQUIRRELVM v, int idx) { return sq_gettype(v,idx) == OT_INTEGER; }
SQINLINE bool	Match(TypeWrapper<short>,HSQUIRRELVM v,int idx)          
{
	if ( sq_gettype(v,idx) & SQOBJECT_NUMERIC ) return true;
	return false;
}
SQINLINE bool	Match(TypeWrapper<unsigned short>,HSQUIRRELVM v,int idx) 
{
	if ( sq_gettype(v,idx) & SQOBJECT_NUMERIC ) return true;
	return false;
}
SQINLINE bool	Match(TypeWrapper<int>,HSQUIRRELVM v,int idx)            
{
	if ( sq_gettype(v,idx) & SQOBJECT_NUMERIC ) return true;
	return false;
}
SQINLINE bool	Match(TypeWrapper<unsigned int>,HSQUIRRELVM v,int idx)
{
	if ( sq_gettype(v,idx) & SQOBJECT_NUMERIC ) return true;
	return false;
}
SQINLINE bool	Match(TypeWrapper<long>,HSQUIRRELVM v,int idx)
{
	if ( sq_gettype(v,idx) & SQOBJECT_NUMERIC ) return true;
	return false;
}
SQINLINE bool	Match(TypeWrapper<unsigned long>,HSQUIRRELVM v,int idx)
{
	if ( sq_gettype(v,idx) & SQOBJECT_NUMERIC ) return true;
	return false;
}
SQINLINE bool	Match(TypeWrapper<float>,HSQUIRRELVM v,int idx)
{
	if ( sq_gettype(v,idx) & SQOBJECT_NUMERIC ) return true;
	return false;
}
SQINLINE bool	Match(TypeWrapper<double>,HSQUIRRELVM v,int idx)
{
	if ( sq_gettype(v,idx) & SQOBJECT_NUMERIC ) return true;
	return false;
}
