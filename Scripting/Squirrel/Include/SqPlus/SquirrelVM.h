...
public:
    ...
    static SquirrelObject &GetHolderArray(void) {return _holder_array_ref;}
...
private:
    ...
    static SquirrelObject _holder_array_ref;
};
...
#define SQ_HOLDER_ARRAY _SC("__ha")
#define SQ_HOLDER_ARRAY_RET 0
#define SQ_HOLDER_ARRAY_LENGTH 1
